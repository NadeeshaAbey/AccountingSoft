...
namespace AccountingSoft.Data.Ds {
    ...
    public partial class AccDs : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string FirstName, string LastName, string Gender, string LandLine, string CellNum, string Email, string Address, string Comment, string RegUser, System.DateTime RegDate, System.TimeSpan RegTime) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public string RegUser {
                get {
                    try {
                        return ((string)(this[this.tableCustomers.RegUserColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'RegUser\' in table \'Customers\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableCustomers.RegUserColumn] = value;
                }
            }
            ...
            public bool IsRegUserNull() {
                return this.IsNull(this.tableCustomers.RegUserColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetRegUserNull() {
                this[this.tableCustomers.RegUserColumn] = global::System.Convert.DBNull;
            }
...
namespace AccountingSoft.Data.Ds.AccDsTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Customers] ([FirstName], [LastName], [Gender], [LandLine], [CellNum], [Email], [Address], [Comment], [RegUser], [RegDate], [RegTime]) VALUES (@FirstName, @LastName, @Gender, @LandLine, @CellNum, @Email, @Address, @Comment, @RegUser, @RegDate, @RegTime);
SELECT ID, FirstName, LastName, Gender, LandLine, CellNum, Email, Address, Comment, RegUser, RegDate, RegTime FROM Customers WHERE (ID = SCOPE_IDENTITY()) ORDER BY ID";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Customers] SET [FirstName] = @FirstName, [LastName] = @LastName, [Gender] = @Gender, [LandLine] = @LandLine, [CellNum] = @CellNum, [Email] = @Email, [Address] = @Address, [Comment] = @Comment, [RegUser] = @RegUser, [RegDate] = @RegDate, [RegTime] = @RegTime WHERE (([ID] = @Original_ID) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_LandLine = 1 AND [LandLine] IS NULL) OR ([LandLine] = @Original_LandLine)) AND ((@IsNull_CellNum = 1 AND [CellNum] IS NULL) OR ([CellNum] = @Original_CellNum)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Comment = 1 AND [Comment] IS NULL) OR ([Comment] = @Original_Comment)) AND ((@IsNull_RegUser = 1 AND [RegUser] IS NULL) OR ([RegUser] = @Original_RegUser)) AND ((@IsNull_RegDate = 1 AND [RegDate] IS NULL) OR ([RegDate] = @Original_RegDate)) AND ((@IsNull_RegTime = 1 AND [RegTime] IS NULL) OR ([RegTime] = @Original_RegTime)));
SELECT ID, FirstName, LastName, Gender, LandLine, CellNum, Email, Address, Comment, RegUser, RegDate, RegTime FROM Customers WHERE (ID = @ID) ORDER BY ID";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=NADEESHA\\SQLEXPRESS;Initial Catalog=Accounting;Integrated Security=Tr" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, Gender, LandLine, CellNum, Email, Address, Commen" +
                "t, RegUser, RegDate, RegTime\r\nFROM     Customers\r\nORDER BY ID";
        ...
        public virtual int Delete(int Original_ID, string Original_FirstName, string Original_LastName, string Original_Gender, string Original_LandLine, string Original_CellNum, string Original_Email, string Original_Address, string Original_Comment, string Original_RegUser, global::System.Nullable<global::System.DateTime> Original_RegDate, global::System.Nullable<global::System.DateTime> Original_RegTime) {
            ...
            if ((Original_RegUser == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[18].Value = ((string)(Original_RegUser));
            }
        ...
        public virtual int Insert(string FirstName, string LastName, string Gender, string LandLine, string CellNum, string Email, string Address, string Comment, string RegUser, global::System.Nullable<global::System.DateTime> RegDate, global::System.Nullable<global::System.DateTime> RegTime) {
            if ((FirstName == null)) {
            ...
            if ((RegUser == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[8].Value = ((string)(RegUser));
            }
        ...
        public virtual int Update(
            ...
            if ((RegUser == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(RegUser));
            }
            if ((RegDate.HasValue == true)) {
            ...
            if ((Original_RegUser == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[29].Value = ((string)(Original_RegUser));
            }
            if ((Original_RegDate.HasValue == true)) {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<global::System.DateTime> Original_RegDate, 
                    global::System.Nullable<global::System.DateTime> Original_RegTime) {
            return this.Update(FirstName, LastName, Gender, LandLine, CellNum, Email, Address, Comment, RegUser, RegDate, RegTime, Original_ID, Original_FirstName, Original_LastName, Original_Gender, Original_LandLine, Original_CellNum, Original_Email, Original_Address, Original_Comment, Original_RegUser, Original_RegDate, Original_RegTime, Original_ID);
        }
    }
